...
@JsonPropertyOrder({
  ...
  GetEventResponsePayload.JSON_PROPERTY_PRICE_CURVE_DELTA,
  GetEventResponsePayload.JSON_PROPERTY_PRICE_AREA,
...
public class GetEventResponsePayload {
  ...
  @jakarta.annotation.Nonnull private PriceCurve priceCurveDelta;

  public static final String JSON_PROPERTY_PRICE_AREA = "priceArea";
  @jakarta.annotation.Nonnull private PriceArea priceArea;
  ...
  @JsonProperty(value = JSON_PROPERTY_PAYLOAD_TYPE, required = true)
  ...
  public GetEventResponsePayload priceCurveDelta(
      @jakarta.annotation.Nonnull PriceCurve priceCurveDelta) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_PRICE_CURVE_DELTA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_PRICE_CURVE_DELTA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPriceCurveDelta(@jakarta.annotation.Nonnull PriceCurve priceCurveDelta) {
    this.priceCurveDelta = priceCurveDelta;
  }

  public GetEventResponsePayload priceArea(@jakarta.annotation.Nonnull PriceArea priceArea) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_PRICE_AREA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_PRICE_AREA, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPriceArea(@jakarta.annotation.Nonnull PriceArea priceArea) {
    this.priceArea = priceArea;
  }
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_ADDED_USERS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_REMOVED_USERS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.payloadType, getEventResponsePayload.payloadType)
        && Objects.equals(this.targets, getEventResponsePayload.targets)
        && Objects.equals(this.priceCurveDelta, getEventResponsePayload.priceCurveDelta)
        && Objects.equals(this.priceArea, getEventResponsePayload.priceArea)
        && Objects.equals(this.lastUpdated, getEventResponsePayload.lastUpdated)
  ...
  public int hashCode() {
    return Objects.hash(
        payloadType, targets, priceCurveDelta, priceArea, lastUpdated, addedUsers, removedUsers);
  }
