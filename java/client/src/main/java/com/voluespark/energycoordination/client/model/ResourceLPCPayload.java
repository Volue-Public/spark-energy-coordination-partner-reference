...
public class ResourceLPCPayload extends SparkEventPayload {
  ...
  @jakarta.annotation.Nonnull private List<ResourceLPCTarget> targets = new ArrayList<>();

  public ResourceLPCPayload() {}

  public ResourceLPCPayload targets(@jakarta.annotation.Nonnull List<ResourceLPCTarget> targets) {
  ...
  @JsonProperty(JSON_PROPERTY_TARGETS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTargets(@jakarta.annotation.Nonnull List<ResourceLPCTarget> targets) {
    this.targets = targets;
  }

  @Override
  public ResourceLPCPayload payloadType(
