...
public class GetUsersResponse {
  ...
  public GetUsersResponse pagination(@jakarta.annotation.Nonnull ApiPagination pagination) {
  ...
  public GetUsersResponse users(@jakarta.annotation.Nullable List<GetUserResponse> users) {
