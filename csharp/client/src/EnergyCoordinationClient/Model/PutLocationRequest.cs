...
namespace EnergyCoordinationClient.Model
{
    ...
    /// PutLocationRequest
    /// </summary>
    [DataContract(Name = "PutLocationRequest")]
    public partial class PutLocationRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PutLocationRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PutLocationRequest() { }
        ...
        )
        {
            ...
            if (locationId == null)
            {
                throw new ArgumentNullException(
                    "locationId is a required property for PutLocationRequest and cannot be null"
                );
            }
