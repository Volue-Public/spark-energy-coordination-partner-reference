...
namespace EnergyCoordinationClient.Client
{
    /// <summary>
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.sandbox.voluespark.com/energy-coordination/v1";
            ...
            {
                {
                    ...
                    {
                        { "url", "https://api.sandbox.voluespark.com/energy-coordination/v1" },
        ...
        public Configuration(
            ...
            string basePath = "https://api.sandbox.voluespark.com/energy-coordination/v1"
        )
            : this()
        {
        ...
        {
            string report = "C# SDK (EnergyCoordinationClient) Debug Report:\n";
